...
execute_process(
  COMMAND "/usr/bin/git" show-ref "v3.0.0-preview4"
  WORKING_DIRECTORY "/home/matt/CLionProjects/CMakeStarter/cmake-build-release/_deps/catch2-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/matt/CLionProjects/CMakeStarter/cmake-build-release/_deps/catch2-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/matt/CLionProjects/CMakeStarter/cmake-build-release/_deps/catch2-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
